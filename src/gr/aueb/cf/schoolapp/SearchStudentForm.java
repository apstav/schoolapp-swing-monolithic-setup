...
public class SearchStudentForm extends JFrame {
	...
	private String inputStudentLastname;
	...
	public SearchStudentForm() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(SearchStudentForm.class.getResource("/resources/eduv2.png")));
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				inputStudentLastname = txtLastname.getText().trim();
