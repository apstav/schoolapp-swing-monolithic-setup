...
public class UpdateDeleteStudentForm extends JFrame {
	...
	public UpdateDeleteStudentForm() {
		addWindowListener(new WindowAdapter() {
			...
			public void windowActivated(WindowEvent e) {
				...
				try {
					...
					p.setString(1, Main.getSearchStudentForm().getInputLastname() + '%');
					rs = p.executeQuery();
		...
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(UpdateDeleteStudentForm.class.getResource("/resources/eduv2.png")));
		setTitle("Ενημέρωση / Διαγραφή Εκπαιδευομένου");
		...
		btnFirst.setIcon(new ImageIcon(UpdateDeleteStudentForm.class.getResource("/resources/First record.png")));
		...
		btnPrevious.setIcon(new ImageIcon(UpdateDeleteStudentForm.class.getResource("/resources/Previous_record.png")));
		...
		btnNext.setIcon(new ImageIcon(UpdateDeleteStudentForm.class.getResource("/resources/Next_track.png")));
		...
		btnLast.setIcon(new ImageIcon(UpdateDeleteStudentForm.class.getResource("/resources/Last_Record.png")));
		...
		btnDelete.setBounds(22, 202, 90, 25);
		...
		btnUpdate.setBounds(121, 202, 90, 25);
		...
		btnClose.setBounds(220, 202, 90, 25);
